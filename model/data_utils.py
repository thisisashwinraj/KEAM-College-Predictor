...
class Preprocess:
    def preprocess_last_rank_data():
        ...
        df = df.replace(
            ["Food Engineering & Technology", "Food Science & Technology"],
            "Food Technology",
        )
        ...
        df = df.replace(
            ["Robotic & Automation", "Robotics & Automation"], "Robotics and Automation"
        )
        ...
        df = df.replace(
            ["Metallurgy", "Cyber Security", "Electronics and Computer Engineering"],
            [
    ...
    def generate_college_name_and_code_lookup():
        ...
        college_codes_and_name_dictionary = (
            {}
        )  # Create a dictionary to store code-name values
